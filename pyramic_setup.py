...
markers = pc.PointCloud(EDM=EDM, labels=labels)
...
#     markers.plot(axes=axes, title='Visualization of boards and speakers', c='k', marker='.')
#     plt.show()

#     print 'DoA of Speaker 11 to FPGA:', twitters.doa('FPGA','11')/np.pi*180.,'degrees'
#     print 'DoA of Speaker 11 to BBB:', twitters.doa('BBB','11')/np.pi*180.,'degrees'
